                ...
                <div class="habitacion-reserva-datos-m">
                    <div class="habitacion-reserva-descripcion">
                        <div class="habitacion-reserva-caracteristicas">
                            <h3>Habitación Familiar Premium</h3>
                        ...
                        <div class="habitacion-reserva-detalles">
                            ...
                            <ul class="habitacion-reserva-detalles-datos">
                                <li>Adultos: 2</li>
                                <li>Niños: 2</li>
                                <li>Comodidades: <span>TV 4K UHD</span>, <span>WIFI Gratis</span>, <span>Cable DirecTV</span>, <span>Maquina de café</span>, <span>Teléfono</span>, <span>Escritorio</span>, <span>2 Baños con tina</span>, <span>Bata y pantuflas</span>, <span>Sala grande</span>, <span>Sala de juegos</span>, <span>Servicio de comida</span>, <span>Cortinas electricas</span>, <span>Aire acondicionado</span></li>
                                <li>Tipo de Cama: 2 cama de 2 plazas</li>
                                <li>Categoria: <span>Familiar</span></li>
                                <li>Precio: <span>S/. 450</span> / por noche</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <form class="formulario-reserva">
                            ...
                            <div class="reserva-datos">
                                ...
                                <div class="reserva-datos">
                                    ...
                                    <input type="text" name="habitacionReserva" id="habitacionReserva" value="FAMILIAR PREMIUM" readonly>
                                </div>
