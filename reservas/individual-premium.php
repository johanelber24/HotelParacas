                ...
                <div class="habitacion-reserva-datos-m">
                    <div class="habitacion-reserva-descripcion">
                        <div class="habitacion-reserva-caracteristicas">
                            <h3>Habitación Individual Premium</h3>
                        ...
                        <div class="habitacion-reserva-detalles">
                            ...
                            <ul class="habitacion-reserva-detalles-datos">
                                <li>Adultos: 1</li>
                                <li>Comodidades: <span>TV 4K UHD</span>, <span>WIFI Gratis</span>, <span>Cable DirecTV</span>, <span>Maquina de café</span>, <span>Mini bar</span>, <span>Teléfono</span>, <span>Escritorio</span>, <span>Baño con tina</span>, <span>Agua caliente</span>, <span>Bata y pantuflas</span>, <span>Sala mediana</span>, <span>Servicio de comida</span>, <span>Cortinas electricas</span>, <span>Aire acondicionado</span></li>
                                <li>Tipo de Cama: 1 cama de 2 plazas</li>
                                <li>Categoria: <span>Individual Premium</span></li>
                        ...
                        <form class="formulario-reserva">
                            ...
                            <div class="reserva-datos">
                                ...
                                <div class="reserva-datos">
                                    ...
                                    <input type="text" name="habitacionReserva" id="habitacionReserva" value="INDIVIDUAL PREMIUM" readonly>
                                </div>
