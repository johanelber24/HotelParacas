                    ...
                    <div class="habitacion-reserva-descripcion">
                        ...
                        <div class="habitacion-reserva-detalles">
                            ...
                            <ul class="habitacion-reserva-detalles-datos">
                                <li>Adultos: 1</li>
                                <li>Comodidades: <span>TV 2K HD</span>, <span>WIFI Gratis</span>, <span>Cable movistar</span>, <span>Maquina de café</span>, <span>Teléfono</span>, <span>Escritorio</span>, <span>Baño con tina</span>, <span>Bata y pantuflas</span>, <span>Sala pequeña</span>, <span>Aire acondicionado</span></li>
                                <li>Tipo de Cama: 1 cama de 1 <sub>1/2</sub> plaza</li>
                                <li>Categoria: <span>Individual</span></li>
                                <li>Precio: <span>S/. 200</span> / por noche</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <form class="formulario-reserva">
                            <div class="habitacion-reserva-formulario-detalles">
                                ...
                                <div class="reserva-datos">
                                    ...
                                    <input type="text" name="habitacionReserva" id="habitacionReserva" value="INDIVIDUAL" readonly>
                                </div>
