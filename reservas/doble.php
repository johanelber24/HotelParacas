                    ...
                    <div class="habitacion-reserva-descripcion">
                        ...
                        <div class="habitacion-reserva-detalles">
                            ...
                            <ul class="habitacion-reserva-detalles-datos">
                                ...
                                <li>Tipo de Cama: 2 cama de 1 plaza</li>
                                <li>Categoria: <span>Doble</span></li>
                                <li>Precio: <span>S/. 250</span> / por noche</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <form class="formulario-reserva">
                            ...
                            <div class="reserva-datos">
                                ...
                                <div class="reserva-datos">
                                    ...
                                    <input type="text" name="habitacionReserva" id="habitacionReserva" value="DOBLE" readonly>
                                </div>
